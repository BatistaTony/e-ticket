...
const avatarSize = {
  "super-small": "w-[50px] h-[50px]",
  small: "w-[100px] h-[100px]",
  medium: "w-[150px] h-[150px]",
  large: "w-[250px] h-[250px]",
};
...
interface AvatarProps
  ...
  > {
  src: string;
  type?:keyof typeof avatarSize;
}

export const Avatar = ({ src, type = "small", ...props }: AvatarProps) => {
  return (
    <img
      {...props}
      src={
      ...
      alt="Avatar"
      className={`rounded-full border-2 border-gray-300  ${avatarSize[type]} ${props.className}`}
    />
  );
};
